        ...
        <div className='container-mcl'>
            ...
            <div className="relative lg:-top-33 -top-10 z-0">
                <div className="h-screen">
                    <img src="/Resources/CaseStudy/cover.png" className="object-fill w-full" />
                </div>
            </div>


            <div className='flex flex-col justify-center text-center lg:-mt-48'>
            ...
            <div className='lg:mx-24 mt-12 mx-14'>
            ...
            <div className='flex flex-col justify-center items-center mt-10 Inter-Regular lg:text-f24 text-f14 lg:leading-f40'>
                <div>
            ...
            <div className='lg:mx-28 lg:mt-20 mt-10 mx-14'>
                <div className='flex lg:flex-row justify-center flex-col'>
                    <div className='lg:w-1/2 lg:text-f24 text-f14 lg:leading-f40 Inter-Regular'>
                    ...
                    <div className='lg:w-1/2 lg:text-f24 text-f14 lg:leading-f40 mt-10 lg:mt-0 Inter-Regular'>
            ...
            <div className='lg:mx-28 mx-14 lg:mt-20 mt-10'>
            ...
            <div className='lg:mx-28 mx-14 lg:mt-20 mt-10'>
                <div className='lg:text-f24 text-f14 lg:leading-f40 Inter-Regular'>
            ...
            <div className='lg:mx-24 flex flex-row space-x-4'>
                <div className='w-10/12 flex flex-col'>
                    ...
                    <div className='lg:mt-40'>
                        ...
                        <div className='lg:text-f28 text-f12 lg:leading-f48 mt-4 Inter-Regular'>
