            ...
            <div className='hidden lg:block'>
                <div className="flex flex-row justify-between pt-6 mx-24">
                    ...
                    <div className="w-1/3 flex flex-row justify-end space-x-2">
                        <a rel="noopener noreferrer" className="" target="_blank" href="https://lk.linkedin.com/company/minutecodelabs"><img className="w-8 h-8" src="/Resources/Home/SMI/in.svg" alt="linkedin"></img></a>
                    </div>
                </div>
            ...
            <div className='lg:hidden'>
                ...
                <div className='my-6'>
                    <div className="flex flex-row justify-center space-x-2">
                        <a rel="noopener noreferrer" target="_blank" href="https://lk.linkedin.com/company/minutecodelabs"><img className="w-8 h-8" src="/Resources/Home/SMI/in.svg" alt="linkedin"></img></a>
                    </div>
                </div>
                <div>
